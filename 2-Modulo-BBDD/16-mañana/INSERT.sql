...
INSERT INTO Customers (CustomerName, ContactName, Address, City, PostalCode, Country, Rol)
...
SELECT * FROM Customers;INSERT INTO Customers (CustomerName, ContactName, City, PostalCode, Country)
