...
-- Ejemplos de ORDER BY -> ASC para ascendente y DESC para descendente
    ...
    SELECT DISTINCT CustomerName, Address, PostalCode, Country FROM Customers 
    ...
    SELECT DISTINCT CustomerName, ContactName, Address, PostalCode, Country FROM Customers 
    WHERE CustomerName LIKE 'a%' AND Country IN ('España', 'Argentina', 'Venezuela', 'Mexico')
